 ...
 */
router.get("/localidad/:localidadId/siguiente-inteligente", RondaController_1.RondaController.obtenerSiguienteInteligente);
// ---------------------------------------------------------------------------
 ...
 * 200 | 400 | 500
 */
router.get("/:id/info", RondaController_1.RondaController.obtenerInfoRonda);
/**
 ...
 */
router.patch("/:id/concluir", RondaController_1.RondaController.marcarRondaComoConcluida);
