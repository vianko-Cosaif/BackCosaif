...
exports.obtenerActualizaciones = obtenerActualizaciones;
exports.crearActualizacion = crearActualizacion;
exports.obtenerUltimaActualizacion = obtenerUltimaActualizacion;
exports.actualizarActualizacion = actualizarActualizacion;
...
*/
async function crearActualizacion(nombre, fechalanzamiento, estado = client_1.EstadoActualizacion.ACTIVA) {
    try {
 ...
 */
async function actualizarActualizacion(id, cambios) {
    // Filtra las claves realmente modificables
    const data = {};
    if (cambios.nombre !== undefined)
        data.nombre = cambios.nombre;
    if (cambios.fechalanzamiento !== undefined)
        data.fechalanzamiento = cambios.fechalanzamiento;
